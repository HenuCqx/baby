...
import com.myxh.baby.ui.fragment.AroundFragment;
import com.myxh.baby.ui.fragment.HomeFragment;
import com.myxh.baby.ui.fragment.MeFragment;
import com.myxh.baby.ui.fragment.MoreFragment;
import com.myxh.baby.ui.fragment.ViewFragment;
...
public class MainActivity extends BaseActivity {
    ...
    private Class[] fragments = new Class[]{
            HomeFragment.class,ViewFragment.class,AroundFragment.class,
            MeFragment.class,MoreFragment.class};
    private int[] resTitles = new int[] {
            R.string.tab_title_home,R.string.tab_title_view,R.string.tab_title_around,
            R.string.tab_title_me,R.string.tab_title_more};
    private int[] icons = new int[]{
            R.drawable.tab_home_selector,R.drawable.tab_view_selector,R.drawable.tab_around_selector,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i.setDataAndType(Uri.parse("file://" + "com.myxh.baby"),"application/vnd.android.package-archive");
